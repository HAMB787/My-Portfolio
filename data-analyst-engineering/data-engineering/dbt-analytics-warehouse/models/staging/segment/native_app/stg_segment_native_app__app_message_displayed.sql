...
{% set ids        = ['anonymous_id', 'message_id', 'context_device_id', 'context_instance_id', 'id', 'user_id'] %}
...
with
base_source as (select * from {{ source('segment_native_app', 'member_appmessage_displayed') }}),
