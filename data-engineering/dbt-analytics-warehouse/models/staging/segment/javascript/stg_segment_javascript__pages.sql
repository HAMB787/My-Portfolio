...
{% set strings = [
    ...
    'context_campaign_r444rrr4r4medium',
    'context_campaign_source_test',
    'traits_pricing_variation',
    'traits_variation',
    'traits_affiliate',
    'affiliate',
    'variation',
    ...
    'context_timezone',
    'typeform_variation',
    'context_campaign_3butm_campaign',
    'context_campaign_3butm_medium',
    'context_campaign_3butm_source',
    'context_campaign_3butm_term',
...
with
base_source as (select * from {{ source('segment_javascript', 'pages') }} WHERE context_library_name = 'analytics.js'), -- filtering errorneous data
...
adapt_variables_names as (
    SELECT
        ...
        uuid_ts,
        fbc,
        context_campaign_course AS campaign_course,
        ...
        affiliate,
        variation,
        context_campaign_utm_source AS campaign_utm_source,
        context_timezone AS timezone,
        typeform_variation,
        ttclid,
        context_campaign_3butm_campaign AS campaign_3butm_campaign,
        context_campaign_3butm_medium AS campaign_3butm_medium,
        context_campaign_3butm_source AS campaign_3butm_source,
        context_campaign_3butm_term AS campaign_3butm_term,
        context_campaign_utm_term AS campaign_utm_term,
        lead_variation,
